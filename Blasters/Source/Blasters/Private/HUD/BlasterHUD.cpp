...
void ABlasterHUD::DrawCrosshair(UTexture2D* Texture, FVector2D ViewportCenter,FVector2D Spread, FLinearColor CrosshairColor)
{
	...
	//texture中心点位置
	const FVector2D TextureDrawPoint(ViewportCenter.X - (TextureWidth / 2.f)-Spread.X, ViewportCenter.Y - (TextureHight / 2.f)-Spread.Y);
...
void ABlasterHUD::SetHUDPackage(const FHUDPackage& Package, float Spread)
{
	HUDPackage = Package; 
